...
(class Execution {
  ...
  static execute(sourceCode, compiledCode) {
    ...
    lambda = (undefined, function (...args) {
      ...
      tmp10 = runtime.safeCall(Components.execution.print.appendChild(tmp9));
      return runtime.Unit
    });
    tmp = lambda;
    Predef.print = tmp;
    ...
    lambda1 = (undefined, function (result, start, end) {
      ...
      if (scrut === true) {
        ...
        return runtime.safeCall(Components.execution.items.appendChild(tmp16))
      }
    });
    tmp2 = lambda1;
    ...
    lambda3 = (undefined, function (error) {
      ...
      return runtime.safeCall(Components.execution.items.appendChild(tmp6))
    });
